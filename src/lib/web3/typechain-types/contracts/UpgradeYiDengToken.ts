...
export interface UpgradeYiDengTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "TOKENS_PER_ETH"
...
export interface UpgradeYiDengToken extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeYiDengToken;
  waitForDeployment(): Promise<this>;

  interface: UpgradeYiDengTokenInterface;
