...
export interface UpgradeYiDengTokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "TOKENS_PER_ETH"
...
export interface UpgradeYiDengTokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeYiDengTokenV2;
  waitForDeployment(): Promise<this>;

  interface: UpgradeYiDengTokenV2Interface;
